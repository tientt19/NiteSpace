...
//  myElcom
//
//  Created by Valerian on 01/08/2022.
//
...
open class TagView: UIButton {
    ...
    @IBInspectable open var TagViewBorderWidth: CGFloat = 0 {
        didSet {
            layer.borderWidth = TagViewBorderWidth
        }
    }
    
    @IBInspectable open var TagViewBorderColor: UIColor? {
        didSet {
            reloadStyles()
        }
    }
